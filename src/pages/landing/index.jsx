...
export default function Landing() {
  return (
    <main className="landing">
      ...
      <article className="card">
        <h3>Jag är ansluten till E-passi och mina behandlingar är friskvårdsberättigade</h3>
        <p>Jag är en del av Holistic Mind och mina bokningsbara behandlingar finns på bokadirekt.se. </p>
        <p>Om du inte hittar en tid som passar så hör av dig till mig så löser vi något.</p> 
      ...
      <article className="card">
        ...
        <p>Mitt tillvägagångssätt i coaching och uppbyggnad av stresshanteringskurser bygger på kunskaper jag fått genom KBT och ACT coach-utbildningen samt mitt yrke som lärare. Jag gick redan som 20-åring min första utbildning i mental träning och intresset för vår kapacitet till att växa och må bättre har bara växt sig starkare. Mitt sätt att coacha bygger även på mina kunskap om allt från anknytningsteori, känslokompetens till mindfulness och CFT. Utifrån egna erfarenheter av stress och stresshantering ger jag praktiska kunskaper och tekniker till dig som blir användbara i vardagen.</p>
      </article>
      <article className='card'>
